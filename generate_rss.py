...
urls = [
    ...
    'https://zaanstad.bestuurlijkeinformatie.nl/Reports/Details/36b1b6ca-8c4b-4d88-b910-a1edba601ac1'
]
...
ET.SubElement(channel, 'description').text = 'Samengevoegde feed van meerdere Zaanstad stukken'
